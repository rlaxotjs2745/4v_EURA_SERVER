    ...
    <section class="content" id="content">
        <div class="page">
            <div class="meeting__dash">
                ...
                <div class="casing">
                    <div class="case-1">
                        <div class="case__title">인간 공학 개론</div>
                        <dl class="type__host">
                            <dt>강의내용</dt>
                    ...
                    <div class="case-2">
                        <div class="case__message is-live"><img src="resources/static/assets/image/ic_time-record_24.png" alt="">00:00:01</div>
                    </div>
                    <div class="case-3">
            ...
            <div class="meeting__user">
                <h3>미팅 참석자 <div class="user__count"><img src="resources/static/assets/image/ic_participant_24.png" alt="">30/32</div>
                </h3>
                <div class="usering">
                                ...
                                <div class="user "><!--is-disabled-->
                                    <ul>
                                        <li>
                                            ...
                                            <span class="team__user">강채연 <img src="resources/static/assets/image/ic_host.png" alt=""><em>postechkim@postech.com</em></span>
                                            <span class="team__badge">나</span>
                                        </li>
                                        <li class="hilight__normal">
                                            <figure><img src="resources/static/assets/image/Ellipse 164.png" alt=""></figure>
                                        ...
                                        <li>
                                            <figure><img src="resources/static/assets/image/image_profile.png" alt=""></figure>
                                            <span class="team__user">제갈민정<em>postechkim@postech.com</em></span>
                                            <span class="badge__camera"><img src="resources/static/assets/image/ic_camera_off.png" alt=""></span>
                                        </li>
                                        <li class="hilight__bad">
                                            <figure><img src="resources/static/assets/image/image_profile.png" alt=""></figure>
                                            <span class="team__user">제갈민정<em>postechkim@postech.com</em></span>
                                        </li>
                                        <li class="hilight__bad">
                    ...
                    <div class="btn__group">
                        <a href="#none" class="btn btn__able btn__xl disabled">시작하기</a>
                    </div>
                </div>
            </div>
            <!--//-->
