        ...
        <div class="join profile">
            ...
            <div class="join__box">
                <div class="input__group upload__type">
                    ...
                    <div class="upload__image"><img  id="preview" src="resources/static/assets/image/Ellipse 164.png" alt=""></div>
                </div>
            </div>

            <div class="btn__box">
                <div class="btn__group">
                    <button id="go_next" class="btn btn__able">완료</button>
                </div>
            </div>
        </div>
    </section>
...
<script>
    ...
    $("#go_next").click(function(){
        ...
        sendPost('join_terms', JSON.stringify(param));
