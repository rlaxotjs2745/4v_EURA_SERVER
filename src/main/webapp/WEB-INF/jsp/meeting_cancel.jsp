        ...
        <div class="page">
            <div class="meeting__dash">
                <h3>미팅룸 정보
                    <!--호스트뷰일때만 나옴-->
                    <div class="sorting">
                        <a href="#popup__delete" class="btn btn-delete js-modal-alert"><img src="resources/static/assets/image/ic_delete_16.png" alt="">미팅 삭제하기</a>
                    </div>
                </h3>
                <div class="casing">
                    <div class="case-1">
                    ...
                    <div class="case-2">
                        <div class="case__message is-cancel">취소된 상태</div>
                    </div>
                    <div class="case-3">
            ...
            <div id="popup__delete" class="pop__detail">
                ...
                <div class="popup__cnt">
                    <div class="pop__message">
                        ...
                        <strong>미팅룸 삭제시 개설한 미팅룸의 정보가 사라집니다.<br>
                            미팅룸을 삭제 하시겠습니까?</strong>
                    </div>
                    <div class="btn__group">
                        <a href="#none" class="btn btn__able btn__s js-modal-close">예</a>
