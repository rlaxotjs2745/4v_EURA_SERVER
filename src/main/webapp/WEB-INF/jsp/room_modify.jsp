        ...
        <div class="room">
            ...
            <div class="room__box">
                <div class="input__group ">
                    <label for="make_new">미팅 이름</label>
                    <input type="text" class="text" id="make_new" value="인간공학개론"  />
                    <!--//-->
                    <hr>
                    <!--1013 input 사이즈 추가-->
                    ...
                    <input id="make_time" type="time" pattern="[0-9]{2}:[0-9]{2}" class="text under-scope width-flexble" style="width:130px;"> <span class="bar">-</span> <input id="make_time" type="time" class="text under-scope width-flexble" style="width:130px;">
                    <!--//-->

                    <hr>
                    <div class="checkbox type__square">
                        <input type="checkbox" class="checkbox" id="cb-2" checked />
                        <label for="cb-2">되풀이 미팅</label>
                    </div>
                    <!--//-->
                    <dl class="inline__type">
                        <dt><label for="room_repeat">반복 주기</label></dt>
                        <dd>
                            <select name="" id="room_repeat" class="make-select">
                        ...
                        <dt><label for="room_repeat2">반복 횟수</label></dt>
                        <dd>
                            <select name="" id="room_repeat2" class="make-select">
                    ...
                    <hr>
                    <dl class="inline__type">
                        <dt><label for="월">반복 요일</label></dt>
                        <dd>
                            <div class="checkbox type__square">
                                <input type="checkbox" class="checkbox" id="월" />
                                <label for="월">월</label>
                            </div>
                            <div class="checkbox type__square">
                                <input type="checkbox" class="checkbox" id="화" />
                                <label for="화">화</label>
                            </div>
                            <div class="checkbox type__square">
                                <input type="checkbox" class="checkbox" id="수" checked />
                                <label for="수">수</label>
                            </div>
                            <div class="checkbox type__square">
                                <input type="checkbox" class="checkbox" id="목" />
                                <label for="목">목</label>
                            </div>
                            <div class="checkbox type__square">
                                <input type="checkbox" class="checkbox" id="금" />
                                <label for="금">금</label>
                            </div>
                            <div class="checkbox type__square">
                                <input type="checkbox" class="checkbox" id="토" />
                                <label for="토">토</label>
                            </div>
                            <div class="checkbox type__square">
                                <input type="checkbox" class="checkbox" id="일" />
                                <label for="일">일</label>
                            </div>
                        </dd>
                    </dl>
                    <hr>
                    <dl class="inline__type">
                        <dt><label for="종료 날짜">종료 날짜</label></dt>
                        <dd>
                            <input id="종료 날짜" type="date" class="text under-scope" value="2022-12-31">
                        </dd>
                    </dl>
                </div>
                
                <div class="input__group">
                    <label for="make_room">미팅 정보</label>
                    <textarea name="" id="make_room" cols="10" rows="3" placeholder="미팅정보를 입력해주세요.">이번에는 인간공학개론 제 4절 인간의 형태와 운동기능 에 대해 알아봅시다. 자세한 사항
은 아래 첨부파일을 참고하시길 바랍니다.</textarea>
                </div>
            ...
            <div class="btn__box">
                <div class="btn__group">
                    <a href="room_new.jsp" class="btn btn__normal">최소</a>
                    <a href="#none" class="btn btn__able">저장</a>
                </div>
            </div>
