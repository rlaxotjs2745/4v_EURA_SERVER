...
<div class="wrapper" id="wrapper">
    ...
    <section class="content" id="content">
        <div class="join temporary">
            <h2>임시 비밀번호 발급</h2>
            <div class="desc__h2">가입 시 사용한 이메일을 입력하세요.</div>

            <div class="join__box">
                <div class="input__group">
                    <label for="login_mail">아이디(이메일)</label>
                    <input type="text" class="text" id="login_mail" placeholder="이메일을 입력하세요" />
                </div>
            </div>

            <div class="btn__box">
                <div class="btn__group">
                    <a href="join_mail.jsp" class="btn btn__able">임시 비밀번호 발송하기</a>
                </div>
            </div>
        </div>
    </section>
