...
<div class="wrapper" id="wrapper">
    ...
    <section class="content" id="content">
        <div class="join temporary">
            <figure><img src="resources/static/assets/image/img_mail.png" alt=""></figure>
            <h3>임시 비밀번호 발송완료</h3>
            <div class="desc__message"><strong>sbpark@uxidstudio.com</strong>로 임시 비밀번호가 발송되었습니다.<br>
                이메일에서 확인 후 비밀번호를 재설정해주세요
            </div>

            <div class="btn__box">
                <div class="btn__group">
                    <a href="login" class="btn btn__able">로그인 화면으로 돌아가기</a>
                </div>
            </div>

            <div class="anchor__box">
                메일을 받지 못 하셨나요? <a href="join_temporary.jsp" class="login__anchor">임시 비밀번호 재발송</a>
            </div>
        </div>
    </section>
</div>
