        ...
        <div class="page">
            <div class="meeting__dash">
                <h3>미팅룸 정보
                    <!--호스트뷰일때만 나옴-->
                    <div class="sorting">
                        <a href="#popup__cancel" class="btn btn-modify js-modal-alert"><img src="resources/static/assets/image/ic_close_16.png" alt="">미팅 취소하기</a>
                    </div>
                </h3>
                <div class="casing">
                    <div class="case-1">
                        <div class="case__title">인간 공학 개론 <a href="#none" class="btn btn__edit"><img src="resources/static/assets/image/ic_edit_24.png" alt=""></a></div>
                        <dl class="type__host">
                            <dt>강의내용</dt>
                    ...
                    <div class="case-2">
                        <div class="case__message is-late">비공개 상태</div>
                    </div>
                    <div class="case-3">
                        <div class="list__upload">
                            <ul>
                                <li>
                                    ...
                                    <!--1013  <a href="#none" class="btn btn__delete"><img src="resources/static/assets/image/ic_cancle-circle_18.png" alt="삭제"></a>-->
                                </li>
                                <li>
                                    <a href="#none">
                                ...
                                <div class="user is-disabled">
                                    <ul>
                                        <li><a href="#none">
                                            ...
                                            <span class="team__user">제갈민정
                                 <em>postechkim@postech.com</em></span>
                                        </a></li>
                                        <li><a href="#none">
                                            <figure><img src="resources/static/assets/image/image_profile.png" alt=""></figure>
                                            <span class="team__user">제갈민정
