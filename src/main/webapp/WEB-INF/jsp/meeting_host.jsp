...
<div class="wrapper" id="wrapper">
    <header class="header ">
        <h1><a href="index.jsp"><img src="../assets/image/h1_logo.png" alt=""></a></h1>
        <div class="user__box">
        ...
        <div class="page">
            <div class="meeting__dash">
                <h3>미팅룸 정보
                    <!--호스트뷰일때만 나옴-->
                    <div class="sorting">
                        <a href="#popup__cancel" class="btn btn-modify js-modal-alert"><img src="../assets/image/ic_close_16.png" alt="">미팅 취소하기</a>
                    </div>
                </h3>
                <div class="casing">
                    <div class="case-1">
                        <div class="case__title">인간 공학 개론
                            <!--호스트뷰일때만 나옴-->
                            <a href="#none" class="btn btn__edit"><img src="../assets/image/ic_edit_24.png" alt=""></a>
                        </div>
                        <dl class="type__host">
                            <dt>강의내용</dt>
                    ...
                    <div class="case-3">
                        <div class="list__upload">
                            ...
                            <ul>
                                <li>
                                    <a href="#none">
                                        <img src="../assets/image/ic_file_14.png" alt=""><span class="file__name">1주차_인간공학의 개요_ppt.pdf</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#none">
                                        <img src="../assets/image/ic_file_14.png" alt=""><span class="file__name">2주차_인간공학을 위한 인간이해_ppt.pdf</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#none">
                                        <img src="../assets/image/ic_file_14.png" alt=""><span class="file__name">3주차_인간의 감각과 그 구조_ppt.pdf</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#none">
                                        <img src="../assets/image/ic_file_14.png" alt=""><span class="file__name">4주차_인간의 형태와 운동기능_ppt.pdf</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="meeting__user">
                <h3>미팅 참석자 <div class="user__count"><img src="../assets/image/ic_participant_24.png" alt="">32</div></h3>
                <div class="usering">
                    ...
                    <div class="btn__group">
                        <a href="#none" class="btn btn__able btn__xl">시작하기</a>
                    </div>
                </div>
            </div>
            <!--//-->
            ...
            <div id="popup__cancel" class="pop__detail">
                ...
                <div class="popup__cnt">
                    ...
                    <div class="btn__group">
                        <a href="#popup__delete" class="btn btn__able btn__s js-modal-alert">예</a>
...
<div class="footer">
  <div class="footer__inner">
    <h2><img src="../assets/image/logo_postech.png" alt="POSTECH"></h2>
...
<script src="../assets/js/lib/jquery-ui.js" type="text/javascript"></script>
