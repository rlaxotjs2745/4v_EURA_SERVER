        ...
        <div class="login">
            ...
            <div class="login__box">
                <div class="input__group">
                    <input type="text" class="text" id="login_id" placeholder="아이디(이메일)" />
                </div>
                <div class="input__group">
                    <input type="password" class="text" id="login_password" placeholder="비밀번호" />
                </div>
                <div class="checkbox">
               ...
               <div class="input__group is-alert">
                ...
                <div class="btn__group">
                    <a href="#none" class="btn btn__able">로그인</a>
                    <a href="join.jsp" class="btn btn__normal">회원가입하기</a>
                </div>
                
                <div class="anchor__box">
                    <a href="join_temporary.jsp" class="login__anchor">비밀번호를 잊으셨나요?</a>
                </div>
            </div>
