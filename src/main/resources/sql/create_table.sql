...
CREATE TABLE `TB_MAIL_MEET` (
	`IDX_MAIL_RESERVED` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
	`IDX_USER` INT(10) UNSIGNED NULL DEFAULT NULL COMMENT '발송회원 ',
	`RECEIVER` VARCHAR(400) NULL DEFAULT NULL COMMENT '메일주소(회원메일) ' COLLATE 'utf8mb4_general_ci',
	`TITLE` VARCHAR(1000) NULL DEFAULT NULL COMMENT '메일 제목 ' COLLATE 'utf8mb4_general_ci',
	`CONTENT` VARCHAR(2000) NULL DEFAULT NULL COMMENT '메일 내용 ' COLLATE 'utf8mb4_general_ci',
	`MAIL_TYPE` TINYINT(1) NULL DEFAULT NULL COMMENT '0:뭘보낸겨, 1:시작, 2:30분전, 3:취소, 4:공개, 5:인증, 6:임시비번',
	`IDX_MEETING_USER_JOIN` INT(11) NULL DEFAULT NULL,
	`REG_DT` DATETIME NULL DEFAULT current_timestamp(),
	PRIMARY KEY (`IDX_MAIL_RESERVED`) USING BTREE
)
COMMENT='미팅 메일 발송 정보'
