...
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='미팅에 초대된 참석자 연결 정보';
...
CREATE TABLE `TB_ANALYSIS` (
  `IDX_ANALYSIS` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='감정 분석 데이터';
