...
ALTER TABLE `TB_MEETING` CHANGE `MT_REMIND_WEEK` `MT_REMIND_WEEK` VARCHAR(20)  CHARACTER SET utf8mb4  COLLATE utf8mb4_general_ci  NULL  DEFAULT NULL  COMMENT '반복요일 - 일,월,화,수,목,금,토 = 1,2,3,4,5,6,7';
